...
if 'intial_context' not in st.session_state:
    ...
    with tab1:
        ...
        if len(upload_file) > 0:
            ...
            if submit_button:
                ...
                st.write(st.session_state.initial_context)
